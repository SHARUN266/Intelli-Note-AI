...
function Suggestions() {
  ...
  return (
    <div className="max-w-4xl mx-auto mt-8 flex w-full flex-col rounded-lg bg-white p-8">
      ...
      <form onSubmit={handleSubmit}>
        ...
        <Link
           ...
           href={`mailto:sharunattari266@gmail.com?subject=Intelli-Note Feedback&body=Type%20your%20feedback%20here...`}
          className="w-full rounded bg-indigo-500 text-center py-2 px-6 text-lg text-white hover:bg-indigo-600 focus:outline-none disabled:bg-gray-400"
        >
           Give your Feedback!

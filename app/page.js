...
<section className="px-2 py-32 bg-white md:px-0">
  ...
  <span className="block text-indigo-600 xl:inline">Notes Taking <span className="block text-red-600 xl:inline">Tool </span>With</span>
  <span className="block xl:inline"> AI Powered </span>
</h1>
<p className="mx-auto text-base text-gray-500 sm:max-w-md lg:text-xl md:max-w-3xl">
  Elevate your PDF experience with AI-powered tools. Extract answers, summaries, and notes seamlessly in just a few clicks.
</p>

          <div className="relative flex flex-col sm:flex-row sm:space-x-4">
            <Link href="/dashboard" className="flex items-center w-full px-6 py-3 mb-3 text-lg text-white bg-gray-800 rounded-md sm:mb-0 hover:bg-indigo-700 sm:w-auto">
              Try It Free
      ...
      <div className="w-full md:w-1/2">
        <div className="w-full flex items-center justify-center h-auto overflow-hidden rounded-md ">
            <Image src={"/heroImg.svg"} alt="hero image" height={300} width={400}/>
          </div>
      </div>
    </div>
  </div>
        ...
        <div className="container flex flex-col items-start mx-auto lg:items-center">
            ...
            <div className="items-center justify-center w-full mt-12 mb-4 lg:flex">
                <div className="flex flex-col items-start justify-start w-full h-auto mb-12 lg:w-1/3 lg:mb-0">
                    ...
                    <blockquote className="mt-8 text-lg text-gray-500">"This is a no-brainer if you want to take your notes to the next level. If you are looking for the ultimate toolset, this is it!"</blockquote>
                </div>
    ...
    <div className="max-w-screen-xl px-4 py-12 mx-auto space-y-8 overflow-hidden sm:px-6 lg:px-8">
        <nav className="flex flex-wrap justify-center -mx-5 -my-2">
            <div className="px-5 py-2">
                <a href="https://www.termsfeed.com/live/cbf1d044-b5c0-4b57-b54a-2f7e1985dd3e" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                    About
                </a>
            </div>
           
            <div className="px-5 py-2">
                <a href="https://www.linkedin.com/in/sharun266/" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Team
                </a>
            </div>
            <div className="px-5 py-2">
                <Link href="/dashboard/upgrade" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Pricing
                </Link>
            </div>
            <div className="px-5 py-2">
                <a href="mailto:sharunattari266@gmail.com" className="text-base leading-6 text-gray-500 hover:text-gray-900">
                    Contact
                </a>
            </div>
            <div className="px-5 py-2">
